...
CREATE TABLE `main_cartitem` (
  ...
  PRIMARY KEY (`id`),
  KEY `main_cartitem_cart_id_8357cf81_fk_main_cart_id` (`cart_id`),
  KEY `main_cartitem_product_id_777783fc_fk_main_product_id` (`product_id`),
  CONSTRAINT `main_cartitem_cart_id_8357cf81_fk_main_cart_id` FOREIGN KEY (`cart_id`) REFERENCES `main_cart` (`id`),
  CONSTRAINT `main_cartitem_product_id_777783fc_fk_main_product_id` FOREIGN KEY (`product_id`) REFERENCES `main_product` (`id`)
...
CREATE TABLE `main_orderitem` (
  ...
  KEY `main_orderitem_product_id_b90dba64_fk_main_product_id` (`product_id`),
  CONSTRAINT `main_orderitem_order_id_72ea9725_fk_main_order_id` FOREIGN KEY (`order_id`) REFERENCES `main_order` (`id`),
  CONSTRAINT `main_orderitem_product_id_b90dba64_fk_main_product_id` FOREIGN KEY (`product_id`) REFERENCES `main_product` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
